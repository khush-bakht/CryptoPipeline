...
import { BarChart3, Sparkles, Construction, TrendingUp, Users, Brain } from "lucide-react"
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/analytics">
                <Button variant="ghost" className="text-emerald-600 hover:bg-emerald-50 font-medium bg-emerald-50">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <Card className="max-w-md w-full bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto mb-4 p-4 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-full w-fit">
            ...
            <CardContent className="text-center">
              <div className="inline-flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-200 mb-6">
                ...
                <span className="text-sm text-emerald-700 font-medium">Insights coming soon</span>
              </div>
              <p className="text-sm text-slate-500 mb-6">
                We're building comprehensive analytics tools including performance metrics, risk analysis, portfolio
                insights, and detailed trading reports.
              </p>
              <Link href="/">
